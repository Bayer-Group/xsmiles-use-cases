# Code modified from  https://github.com/jensengroup/FP_RF_XAI
# in reference to the original article: https://chemrxiv.org/engage/chemrxiv/article-details/622f215f968f5252a0ba640d
# The original code is under MIT License - Copyright (c) 2022 Jensen Group
...
def mol2fp(mol, radius=1, n_bits=1024):
    bi = {}
...
def mod_fp_exchange(mol, idx_atom, radius=1, dummy_atom_no=47, n_bits=1024):
    info = {}
...
def AAU_weights(mol, model, radius=1, n_bits=2048):
...
def RDKit_bit_vector(mol, model, radius=1, n_bits=1024):
    ...
    # Prediction with normal fingerprints
...
def get_weights_for_visualization(mol, model, radius=2, n_bits=1024):
    ...
    fp = mol2fp(mol, radius=radius, n_bits=n_bits)
    ...
    return ml_weights, atom_weights, FPA_weights, logp_pred
